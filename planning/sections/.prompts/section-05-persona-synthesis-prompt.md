...
Generate content for section `section-05-persona-synthesis` (filename: `section-05-persona-synthesis.md`).
...
for `section-05-persona-synthesis` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-05-persona-synthesis.md`
