...
Generate content for section `section-06-persona-table` (filename: `section-06-persona-table.md`).
...
for `section-06-persona-table` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-06-persona-table.md`
