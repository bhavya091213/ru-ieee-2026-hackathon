...
Generate content for section `section-08-simulation-rounds` (filename: `section-08-simulation-rounds.md`).
...
for `section-08-simulation-rounds` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-08-simulation-rounds.md`
