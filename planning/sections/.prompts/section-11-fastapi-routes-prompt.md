...
Generate content for section `section-11-fastapi-routes` (filename: `section-11-fastapi-routes.md`).
...
for `section-11-fastapi-routes` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-11-fastapi-routes.md`
