...
Generate content for section `section-02-gemini-client` (filename: `section-02-gemini-client.md`).
...
for `section-02-gemini-client` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-02-gemini-client.md`
