...
Generate content for section `section-05-kpi-status` (filename: `section-05-kpi-status.md`).
...
for `section-05-kpi-status` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-05-kpi-status.md`
