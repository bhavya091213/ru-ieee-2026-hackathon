...
Generate content for section `section-07-parquet-communities` (filename: `section-07-parquet-communities.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/claude-plan.md` - Full implementation plan
2. `/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-07-parquet-communities` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-07-parquet-communities.md`
