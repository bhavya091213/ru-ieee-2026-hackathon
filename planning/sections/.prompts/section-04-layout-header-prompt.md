...
Generate content for section `section-04-layout-header` (filename: `section-04-layout-header.md`).
...
for `section-04-layout-header` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-04-layout-header.md`
