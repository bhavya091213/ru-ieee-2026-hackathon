...
Generate content for section `section-02-web-fetcher` (filename: `section-02-web-fetcher.md`).
...
for `section-02-web-fetcher` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-02-web-fetcher.md`
