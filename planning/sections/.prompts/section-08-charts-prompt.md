...
Generate content for section `section-08-charts` (filename: `section-08-charts.md`).
...
for `section-08-charts` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-08-charts.md`
