...
Generate content for section `section-06-extraction-graph` (filename: `section-06-extraction-graph.md`).
...
for `section-06-extraction-graph` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-06-extraction-graph.md`
