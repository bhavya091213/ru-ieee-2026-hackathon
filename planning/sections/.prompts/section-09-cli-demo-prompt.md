...
Generate content for section `section-09-cli-demo` (filename: `section-09-cli-demo.md`).
...
for `section-09-cli-demo` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-09-cli-demo.md`
