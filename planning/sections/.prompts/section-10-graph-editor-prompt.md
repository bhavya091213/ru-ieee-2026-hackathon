...
Generate content for section `section-10-graph-editor` (filename: `section-10-graph-editor.md`).
...
for `section-10-graph-editor` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-10-graph-editor.md`
