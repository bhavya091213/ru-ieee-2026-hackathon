...
Generate content for section `section-09-heatmap-d3` (filename: `section-09-heatmap-d3.md`).
...
for `section-09-heatmap-d3` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-09-heatmap-d3.md`
