...
Generate content for section `section-08-retrieval` (filename: `section-08-retrieval.md`).
...
for `section-08-retrieval` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-08-retrieval.md`
