...
Generate content for section `section-01-scaffold` (filename: `section-01-scaffold.md`).
...
for `section-01-scaffold` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-01-scaffold.md`
