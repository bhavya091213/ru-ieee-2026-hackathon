...
Generate content for section `section-01-schemas` (filename: `section-01-schemas.md`).
...
for `section-01-schemas` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-01-schemas.md`
