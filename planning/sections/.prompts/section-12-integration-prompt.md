...
Generate content for section `section-12-integration` (filename: `section-12-integration.md`).
...
for `section-12-integration` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-12-integration.md`
