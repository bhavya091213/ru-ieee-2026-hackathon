...
Generate content for section `section-03-extraction` (filename: `section-03-extraction.md`).
...
for `section-03-extraction` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-03-extraction.md`
