...
Generate content for section `section-04-clustering` (filename: `section-04-clustering.md`).
...
for `section-04-clustering` to understand what this section should contain.
...
`/Users/bhavyapatel/Documents/Projects/focus-group-agent/planning/sections/section-04-clustering.md`
